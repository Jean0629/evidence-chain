...
namespace EvidenceChain.Infrastructure.Migrations
{
    ...
    [Migration("20260922162523_MakeEvidenceIndexCovering")]
    partial class MakeEvidenceIndexCovering
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EvidenceChain.Domain.Entities.Evidence", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CreatedAtUtc", "Id"), new[] { "CurrentCustodianId", "Description", "Code" });
